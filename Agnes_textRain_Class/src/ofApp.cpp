...
void ofApp::setup(){
    ...
    /////////////////////////////////////////////////////////////////////////////
    // PAO CHANGES  ---------------------
    // I changed the count of particles
    countParticles = 30;
    /////////////////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////////////////
    ...
    for (int i=0; i < countParticles; i++){
        ...
        /////////////////////////////////////////////////////////////////////////////
        // PAO CHANGES  ---------------------
        // Here in ofApp.cpp we load the font and we send this data to every particle
...
void ofApp::draw(){
    ...
    for (int i =0; i < countParticles; i++){
        ...
        int whichLine = ofGetSeconds()* 2 % linesOfTheFile.size();
        ...
        /////////////////////////////////////////////////////////////////////////////
        // PAO CHANGES  ---------------------
        // Using your code I change the string, position x and y to every particle
        particles[i].draw(temp, pts[i].x, pts[i].y); // drew the particles from setup
        /////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////
